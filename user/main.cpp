...
void Run()
{
	il2cppi_new_console();
	SetConsoleTextAttribute(hConsole, 12);
	il2cppi_log_write("[Cr:4n:kS.t4r] [C4PhasByP] !!! ONLY FOR !!! Server version: 0.3.1.0 - Hotfix #2");
	il2cppi_log_write("[Cr:4n:kS.t4r] [C4PhasByP] !!! ONLY FOR !!! Steam Build ID: 7385401");
